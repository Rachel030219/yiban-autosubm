...
if __name__ == '__main__':
    try:
        ...
        if len(all_task) == 0:
            ...
            dict_form = {"c77d35b16fb22ec70a1f33c315141dbb": util.get_time_no_second(),
                        "2d4135d558f849e18a5dcc87b884cce5": ["36.2", "36.3", "36.4", "36.5", "36.6", "36.7", "36.8"][random.randint(0, 6)], # 随机体温
                        "2fca911d0600717cc5c2f57fc3702787": ["湖南省","长沙市","天心区"],
